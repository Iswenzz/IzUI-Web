...
export const PrevButton: FC<CarouselButtonProps> = ({ disabled, onClick, size = 20 }) => (
	<button
		className={classNames(carouselStyle.button, carouselStyle.buttonPrev)}
		onClick={onClick}
		disabled={disabled}
	>
		<svg width={size} height={size} viewBox="137.718 -1.001 366.563 644">
 ...
 * @param param0 - Object with the indicator click callback & disabled state.
 */
export const NextButton: FC<CarouselButtonProps> = ({ disabled, onClick, size = 20 }) => (
	<button
		className={classNames(carouselStyle.button, carouselStyle.buttonNext)}
		onClick={onClick}
		disabled={disabled}
	>
		<svg width={size} height={size} viewBox="0 0 238.003 238.003">
