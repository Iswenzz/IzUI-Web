...
export const MinusSquare: FC<TreeIconsProps> = props => (
...
export const PlusSquare: FC<TreeIconsProps> = props => (
	<svg {...props} viewBox="64 -65 897 897">
		<g>
...
export const CloseSquare: FC<TreeIconsProps> = props => (
	<svg {...props} viewBox="64 -65 897 897">
		<g>
...
type TreeIconsProps = React.HTMLAttributes<HTMLOrSVGElement>;
