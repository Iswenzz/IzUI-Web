...
export const recurseChildClassNames = (element: Element): string[] => {
	...
	Array.from(element.children).forEach(e => classNames.push(...recurseChildClassNames(e)));
...
export const getElementsByXPath = (xpath: string, contextNode?: Document) => {
	...
	else xpathResult = contextNode.evaluate(xpath, contextNode, null, XPathResult.ANY_TYPE, null);
